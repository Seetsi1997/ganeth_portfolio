        ...
        const fetchEducationData = async () => {
            ...
            try {
                ...
                if (error.response?.status === 404) {
                    ...
                    setErrors((prev) => ({
                        ...prev,
                        education: "Failed to load education data",
                    }));
                }
            } finally {
                setIsLoading(false);
        ...
        const fetchWorkData = async () => {
            try {
                ...
                if (error.response?.status === 404) {
                    ...
                    setErrors((prev) => ({
                        ...prev,
                        work: "Failed to load work experience",
                    }));
                }
            } finally {
                setIsLoading(false);
            ...
            <div className="qualification__timeline">
                {displayedData.map((item, index) => (
                    ...
                    >
                        ...
                        <div
                            className={`qualification__content ${index % 2 === 0 ? "left" : "right"
                                }`}
                        >
                        ...
                        {activeTab === "education" ? (
                                    ...
                                    <ul className="modules-list">
                                        {popupData.modules?.length > 0 ? (
                                            popupData.modules.map((module, index) => {
                                                const isFailed =
                                                    (popupData.institutionType === "highSchool" &&
                                                        module.percent < 30) ||
                                                    (popupData.institutionType === "university" &&
                                                        module.percent < 50);
                                                ...
                                                return (
                                                    <li
                                                        key={index}
                                                        className={
                                                            isFailed ? "module-failed" : "module-passed"
                                                        }
                                                    >
                            ...
                            <>
                                ...
                                <div className="achievement-section">
                                    ...
                                    <ul className="achievement-list">
                                        {popupData.achievements?.map((achievement, index) => (
                                            <li
                                                key={index}
                                                className={`achievement-item ${achievement.proficiency}`}
                                            >
                                ...
                                <div className="skills-section">
                                    <h3>
                                        Skills Gained (<span>{popupData.skillCount}</span>)
                                    </h3>
                                    <p className="proficiency-summary">
                                        {popupData.proficiencySummary}
                                    </p>
                                ...
                                <div className="employee-section">
                                    <h3>
                                        Details of Employee (
                                        <span>{popupData.referenceContact?.name || "N/A"}</span>)
                                    </h3>
                                    <p className="proficiency-summary">
                                            ...
                                            <div className="reference-contact">
                                                <div className="contact-item">
                                                    ...
                                                    <div className="contact-value">
                                                        {popupData.referenceContact?.email ||
                                                            "Not provided"}
                                                    </div>
                                                </div>
                                                <div className="contact-item">
                                                    ...
                                                    <div className="contact-value">
                                                        {popupData.referenceContact?.phone ||
                                                            "Not provided"}
                                                    </div>
                                                </div>
                                            </div>
